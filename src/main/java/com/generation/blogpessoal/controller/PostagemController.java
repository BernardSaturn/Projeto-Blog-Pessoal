...
@RestController // anotação que diz para o spring que ela é a acontroladora de roatas e acessos
				// aos metodos
...
public class PostagemController {
	...
	public ResponseEntity<Postagem> post(@Valid @RequestBody Postagem postagem) {
		...
		throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Tema não existel", null);
	}
